...
- [ ] 1. Set up matchup feature structure and types

  - [ ] 1.1 Create matchup feature directory structure
    - Create `src/features/matchup/` with subdirectories: types, services, store, components, pages, hooks
    - Create index.ts barrel exports
    - _Requirements: 1.1, 1.2_
  - [ ] 1.2 Define matchup types and interfaces
  ...
  - [ ] 1.3 Write property test for Matchup serialization round-trip
    - **Property 1: Matchup Serialization Round-Trip**
    - **Validates: Requirements 1.4, 1.5**

- [ ] 2. Implement Matchup Service

  - [ ] 2.1 Create matchupService with CRUD operations
  ...
  - [ ] 2.2 Write property test for same card matchup rejection
    - **Property 2: Same Card Matchup Rejection**
    - **Validates: Requirements 1.3**
  - [ ] 2.3 Write property test for matchup record completeness
    - **Property 3: Matchup Record Completeness**
    - **Validates: Requirements 1.2**
  - [ ] 2.4 Write property test for pending matchup filtering and sorting
    - **Property 4: Pending Matchup Filtering and Sorting**
    - **Validates: Requirements 2.1**

- [ ] 3. Implement Matchup Bet Service

  - [ ] 3.1 Create matchupBetService with bet operations
  ...
  - [ ] 3.2 Write property test for bet history sorting
    - **Property 12: Bet History Sorting**
    - **Validates: Requirements 7.1**

- [ ] 4. Implement Matchup Betting Store

  - [ ] 4.1 Create matchupBettingStore with state management
  ...
  - [ ] 4.2 Write property test for invalid bet rejection
    - **Property 5: Invalid Bet Rejection**
    - **Validates: Requirements 3.2, 3.3**
  - [ ] 4.3 Write property test for bet deduction consistency
    - **Property 6: Bet Deduction Consistency**
    - **Validates: Requirements 3.4**
  - [ ] 4.4 Write property test for non-pending matchup bet prevention
    - **Property 7: Non-Pending Matchup Bet Prevention**
    - **Validates: Requirements 3.6, 4.6**
  - [ ] 4.5 Write property test for bet cancellation refund
    - **Property 8: Bet Cancellation Refund**
    - **Validates: Requirements 4.1**
  - [ ] 4.6 Write property test for bet update balance adjustment
    - **Property 9: Bet Update Balance Adjustment**
    - **Validates: Requirements 4.4, 4.5**
  - [ ] 4.7 Write property test for payout calculation
    - **Property 10: Payout Calculation**
    - **Validates: Requirements 6.1, 6.2, 6.4**
  - [ ] 4.8 Write property test for matchup cancellation refund
    - **Property 11: Matchup Cancellation Refund**
    - **Validates: Requirements 6.5**
  - [ ] 4.9 Write property test for balance persistence consistency
...
- [ ] 6. Implement Matchup UI Components

  - [ ] 6.1 Create MatchupCard component
...
- [ ] 8. Integrate Battle Execution
  ...
  - [ ] 8.2 Integrate payout resolution
  ...
  - [ ] 8.3 Integrate matchup cancellation
    - Admin triggers cancelMatchup
    - Call refundBets to refund all active bets
    - _Requirements: 6.5_

- [ ] 9. Update db.json schema

  - [ ] 9.1 Add matchups and matchupBets collections to db.json
    - Add empty "matchups" array
    - Add empty "matchupBets" array
    - _Requirements: 1.1, 3.5_

- [ ] 10. Add routing for matchup pages

  - [ ] 10.1 Add matchup routes to router
